...
public class PatternSet implements AntBuilderAware, PatternFilterable {
    ...
    /**
     * Like {@link #getIncludes()}, but returns a view or empty set.
     *
    ...
    /**
     * Like {@link #getIncludeSpecs()}, but returns a view or empty set.
     *
     * <p>Use this if you are only reading from the set, as it avoids allocating a set if not needed.</p>
     *
    ...
    /**
     * Like {@link #getExcludes()}, but returns a view or empty set.
     *
     * <p>Use this if you are only reading from the set, as it avoids allocating a set if not needed.</p>
     *
    ...
    /**
     * Like {@link #getExcludeSpecs()}, but returns a view or empty set.
     *
     * <p>Use this if you are only reading from the set, as it avoids allocating a set if not needed.</p>
     *
